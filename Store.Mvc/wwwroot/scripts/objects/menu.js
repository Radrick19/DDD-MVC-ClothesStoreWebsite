class Menu {
	...
	constructor() {
		...
		this.CollectionLinksHandler = this.MainMenu.querySelector('.collections-handler');
		this.SubcategoriesLinksHandler = this.MainMenu.querySelector('.subcategories-handler')
		for (const link of document.querySelectorAll('.main-menu-category-link')) {
			link.addEventListener('mouseover', function () {
				...
				if (self.SelectedCategoryId != null) {
					...
					if (prevSelectedCategoryId != null && prevSelectedCategoryId != self.SelectedCategoryId) {
						self.UpdateLinks();
					}
				}
				else {
	...
	UpdateLinks() {
		let self = this;
		let subcategoriesUrl = '/getsubcategories/' + this.SelectedCategoryId + '/' + false;
		let collectionsUrl = '/getcollections/' + this.SelectedCategoryId + '/' + false;
